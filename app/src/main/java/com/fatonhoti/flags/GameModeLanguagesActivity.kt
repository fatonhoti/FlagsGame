...
class GameModeLanguagesActivity: AppCompatActivity(), GameMode {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_game_languages)
    ...
    override fun checkGuess(guess: String) {
        val primaryLanguage = selectedCountry.languages.split(",")[0]
        if(guess == primaryLanguage) {
            correct++
    ...
    private fun updateViews() {
        ...
        for(i in 0 until choices.size) {
            if (i == randIndex) {
                ...
                val primaryLanguage = selectedCountry.languages.split(",")[0]
                buttons[i].text = primaryLanguage
            } else {
                val primaryLanguage = choices[i].languages.split(",")[0]
                buttons[i].text = primaryLanguage
            }
        }
